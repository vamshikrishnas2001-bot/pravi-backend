...
(async function protectPage() {
  ...
  try {
    ...
    // Any other error (500, timeout) = Render cold start, let them in
  } catch (e) {
    console.warn('Server waking up — allowing access');
  }
  document.body.style.visibility = 'visible'; // ✅ show page only after auth
})();
